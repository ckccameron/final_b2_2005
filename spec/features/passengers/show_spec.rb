...
RSpec.describe "passenger show page" do
  it "displays passenger's name with all flight numbers to their flights which also happen to be links" do
    ...
    flight_1 = Flight.create!(number: "2345", date: "08/03/20", time: "11:00", departure_city: "Denver", arrival_city: "Los Angeles", airline: southwest)
    flight_2 = Flight.create!(number: "3777", date: "09/03/20", time: "08:15", departure_city: "Denver", arrival_city: "New York", airline: southwest)
    flight_3 = Flight.create!(number: "9863", date: "09/23/20", time: "15:30", departure_city: "Denver", arrival_city: "San Diego", airline: southwest)
